<?php
    ...
    function austere_files() {
        ...
        if (strstr($_SERVER['SERVER_NAME'], 'austerus.local')) {
            ...
            wp_enqueue_script('main-js', get_theme_file_uri('/bundled-assets/scripts.8bb219ba5baeb4c25ecf.js'), NULL, microtime(), true);
            wp_enqueue_style('main-styles', get_theme_file_uri('/bundled-assets/styles.8bb219ba5baeb4c25ecf.css'));
        }
